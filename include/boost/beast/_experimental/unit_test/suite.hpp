...
#define BEAST_DEFINE_TESTSUITE_INSERT(Library,ModuleInterface,Class,manual) \
    static ::boost::beast::unit_test::detail::insert_suite <Class##_test>   \
        Library ## ModuleInterface ## Class ## _test_instance(             \
            #Class, #ModuleInterface, #Library, manual)
...
#define BEAST_DEFINE_TESTSUITE(Library,ModuleInterface,Class) \
        BEAST_DEFINE_TESTSUITE_INSERT(Library,ModuleInterface,Class,false)
#define BEAST_DEFINE_TESTSUITE_MANUAL(Library,ModuleInterface,Class) \
        BEAST_DEFINE_TESTSUITE_INSERT(Library,ModuleInterface,Class,true)
